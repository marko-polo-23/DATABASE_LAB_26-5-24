...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `get_chef_name_` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `get_chef_name_`(id INT) RETURNS varchar(255) CHARSET utf8mb4
    DETERMINISTIC
BEGIN
    DECLARE full_name VARCHAR(255);
    
    SELECT CONCAT(chef_name, '_', chef_lastname) INTO full_name
    FROM chefs 
    WHERE id = chef_id;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `EpisodeCreation2` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `EpisodeCreation2`(IN seasons INT)
BEGIN
    DECLARE i INT DEFAULT 1;
    DECLARE episodeCount INT;
    DECLARE episodeId INT DEFAULT 1;  -- Variable to keep track of the episode ID
...
BEGIN
	...
	-- Create the user 'Dev' with a password (replace 'your_password' with the desired password)
    DROP USER IF EXISTS 'admin'@'localhost';
	CREATE USER 'admin'@'localhost' IDENTIFIED BY 'password';

	-- Grant the specified privileges to the user 'Dev'
	GRANT SELECT, EXECUTE, INSERT, UPDATE, ALTER, SHOW VIEW, TRIGGER, LOCK TABLES ON masterchef_ergasia.* TO 'admin'@'localhost';

	-- Flush privileges to ensure that the new grants are applied
	FLUSH PRIVILEGES;

	-- Verify the grants for the user 'Dev'
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `grant_to_chef` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `grant_to_chef`(IN chef_id_param INT)
BEGIN
    DECLARE chef_exists INT DEFAULT 0;
    DECLARE chef_name_val VARCHAR(255);
    DECLARE chef_lastname_val TEXT;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `nRandomCooks_toRespectiveCuisines` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `nRandomCooks_toRespectiveCuisines`(in n int)
BEGIN

	-- This procedure chooses RANDOMLY n cooks from n cuisines and 1 recipe from each cuisine.
    -- It also calls RandomJudge to set 3 random cooks (other than the contestants) as judges.
    -- It also calls set_episode_number to increase or set-to-zero the episodes of the contestants/cuisines/recipes
	
    drop temporary table if exists contestants;
    
    CREATE temporary TABLE contestants as(
    select temp.CookID as CookID, temp.CuisineID, RecipeId, Recipe, temp.grade as Grade
    from
   ( 
    select cc.chef_id as CookID, c.cuisine_speciality_id as CuisineID, Recipe, RecipeID, c.grade as grade,
		row_number() over (partition by c.cuisine_speciality_id order by cc.chef_id) as row_num
    from (
		chefs_cuisines cc join
        (select distinct cc.cuisine_id, recipes.name as Recipe, recipes.recipe_id as RecipeID
        from cuisines cc join recipes on cc.cuisine_id = recipes.cuisine_id and  recipes.recipe_episode <3 and cc.cuisine_episode < 3
        order by rand()
        limit n) cc2 on cc.cuisine_id=cc2.cuisine_id
    ) join chefs c on cc.chef_id=c.chef_id
    where c.episodes<3
    order by c.cuisine_speciality_id
    ) temp
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `RandomJudge` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `RandomJudge`()
BEGIN
	
    -- This procedure picks randomly 3 cooks - judges and saves them in a temporary table "judges"
    
    drop temporary table if exists judges;
    
    create temporary table judges as
    select c.chef_id as JudgeID, concat(c.chef_name, ' ', c.chef_lastname) as JudgeFullName
    from chefs c
    where c.chef_id not in (select CookID from contestants)
    order by rand()
    limit 3;
...
-- Dump completed on 2024-05-26 23:40:26

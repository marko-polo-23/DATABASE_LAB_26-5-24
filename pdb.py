...
def user_chef():
	...
	while True:
		...
		command = input("Choose between what you want to edit ['profile', 'recipes_equipment', 'recipes', 'logout']: ")
					...
					case "alter":
						...
						if change=='recipe_id':
							...
							match change:
								...
								case "difficulty" | "time_prep" | "time_cook" | "portions" | "basic_ing_id" | "fats_per_portion"|"protein_per_portion"|"carbs_per_portion":
	...
	while True:
		...
		try:
			...
			match user_input:
				...
				case "help":
					print("Type a question number or a command you want to use: help, logout")
					continue
				...
				case "run":
					...
					try:
						...
						run_query = f"call EpisodeCreation({seasons})"	
